...
class LocalObservationNotifier
  ...
  /// Submit observasi baru â simpan lokal dulu, sync kalau online
  Future<void> addObservation({
    required String namaSpesies,
    String? namaLokal, // â Baru
    ...
    int? jumlahIndividu, // â Baru
    String? aktivitasTermati, // â Baru
  ...
  /// Update observasi yang sudah ada (mode edit) â status direset ke MENUNGGU_VERIFIKASI
